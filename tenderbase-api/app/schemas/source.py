...
from app.enums import ConnectorType, HealthStatus, JobStatus, ProcurementScope, SourceType
...
class SourceRead(SourceRef):
    ...
    verified_at: datetime | None = Field(
        default=None, description="When a human last verified this source definition"
    )
